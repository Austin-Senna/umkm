...
import type { Product, MenuItem, Menu, BusinessData, MenuCreatorClientProps } from './types';
...
// No need to redefine interfaces here as they are imported from types.ts
      ...
      try {
        ...
        if (business) {
          setBusiness({
            ...
            deployed_at: business.deployed_at,
    ...
    const createNewMenu = async () => {
      try {
        const newMenu: Menu = {
          ...
          name: `${business.business_name}'s Menu`,
          sections: [],
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">No menu found for {business.business_name}</p>
          <button
            ...
            {editingSection === section.id ? (
              <div className="flex gap-4 mb-4">
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEditingSectionName(e.target.value)}
                  className="flex-1 rounded-lg border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
                <button
